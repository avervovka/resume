...
const translations = {
  en: {
    ...
    reference_item1: "Dan Piatrou, Senior Ruby on Rails Developer, +48 789 801 365",
    reference_item2: "Aliaksandr Sabol'ka, QA Lead / Automation Engineer, +375 29 738 78 74",
    reference_item3: "Vladimir Khal'zov, Senior Ruby on Rails Developer, +375 33 344 14 32",
  ...
  ru: {
    ...
    telegram: "Telegram",
    linkedin_label: "LinkedIn:",
    professional_summary_heading: "Обо мне",
    professional_summary_text:
      "Посвятивший себя делу и инновациям <strong>Senior QA инженер</strong> с 6+ летним опытом как аппаратного, так и программного тестирования в сферах Web, IoT и бытовой электроники. Опыт создания надежных стратегий тестирования, оптимизации процессов и сотрудничества с международными командами для обеспечения высокого качества продуктов.",
    core_competencies_heading: "Ключевые навыки",
    testing_item: "Тестирование: ручное, автоматизированное, функциональное и нефункциональное, регрессионное",
    ...
    education_bsc: "Бакалавр в области электроснабжения с/х (электроэнергетика) — Белорусский государственный аграрно-технический университет (2013–2018)",
    ...
    reference_item1: "Дан Петров, Senior Ruby on Rails Developer, +48 789 801 365",
    reference_item2: "Александр Соболько, QA Lead / Automation Engineer, +375 29 738 78 74",
    reference_item3: "Владимир Хальзов, Senior Ruby on Rails Developer, +375 33 344 14 32",
    experience_heading: "Опыт работы",
    job1_title: "Senior QA / QC инженер — Nero Electronics (Unic Lab), Минск, Беларусь",
    job1_dates: "Дек 2024 – настоящее время",
    job1_desc: [
      "Разработка и поддержка автоматизированных тестов на Python для приборов точного измерения, обеспечивая проверку качества продукта.",
      ...
      "Сотрудничество с командами разработки и клиентами для достижения отличных стандартов качества и создания превосходного продукта."
    ],
    job2_title: "Senior QA / QC инженер — Фриланс, по всему миру",
    job2_dates: "Июн 2023 – Дек 2024",
    job2_desc: [
      "Функциональное и API тестирование современных образовательных веб-платформ с использованием Postman, Swagger, ChromeDevTools.",
      "Полный цикл аппаратного и программного тестирования массажного робота для клиента из ОАЭ и РФ.",
    ...
    job3_title: "Senior QA / QC инженер — Rozum Robotics, Минск, Беларусь",
    ...
    job3_desc: [
      ...
      "Поддержание тестовых стендов аппаратного обеспечения в идеальном состоянии для точных, калибровочных и нагрузочных тестов."
    ],
    job4_title: "QA / QC инженер — Clever Labs, Минск, Беларусь",
    job4_dates: "Апр 2021 – Сен 2022",
    job4_desc: [
      "Руководство полным циклом тестирования сложного страхового веб-приложения для США, обеспечение стабильности и соответствия требованиям заказчика.",
      "Взаимодействие с клиентами и командой разработки, оптимизация коммуникаций и технической документации.",
      "Оптимизация процессов QA, значительное сокращение времени на исправление дефектов и ускорение релизов."
    ],
    job5_title: "QA / QC инженер — Zorachka, Минск, Беларусь",
    ...
    job5_desc: [
      ...
      "Тестирование мобильного приложения и внутреннего ПО, выявление и фиксация критических проблем для быстрого устранения.",
      "Создание и поддержка подробной технической документации для разработчиков и конечных пользователей."
    ],
    certificates_heading: "Сертификаты",
    certificate1: "Selenium Python",
    certificate2: "Python OOP",
    certificate3: "HTML & CSS",
    certificate4: "Python Программирование",
    certificate5: "Поколение Python от Тимура Гуева",
